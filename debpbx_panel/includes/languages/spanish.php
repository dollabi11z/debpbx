...
define('HOME', 'Inicio');
define('PBX', 'PBX');
define('FREEPBX', 'FreePBX');
define('FOP', 'FOP: Flash Operator Panel');
define('VITIGERCRM', 'VitigerCRM');
define('AVANTFAX', 'AvantFAX');
define('VOICEMAIL', 'VoiceMail');
define('CALLLOG', 'Calllog');	
define('SUPPORT', 'Soporte');
define('PAID_SUPPORT', 'Soporte Pago');
define('COMMUNITIES', 'Comunidad');
define('CHAT', 'Chat');
define('FORUM', 'Foro');
define('WIKI', 'WiKi');
...
define('TEAM', 'Equipo');
define('FAQS', 'FAQS: Preguntas Frecuentes');
define('FOOTER', 'Todos los derechos reservados.');
?>
