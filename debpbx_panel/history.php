...
$language=idenLang();
require(DIR_WS_LANGUAGES . $language . '/' . 'history.php');
require(DIR_WS_INCLUDES . 'header.php');
?>
	<div id="container">
	<div class="content">
 		<div class="title_about"><h3><?php echo TITLE_HISTORY; ?></h3></div>
 		<div class="text gris about"><?php echo HISTORY_TEXT; ?></div>
	</div>
