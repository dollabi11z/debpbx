...
$language=idenLang();
require(DIR_WS_LANGUAGES . $language . '/' . 'version.php');
require(DIR_WS_INCLUDES . 'header.php');
?>
        <div id="container">
			<div id="changelog_iframe">
				<iframe onload="iFrameHeight()"	id="changelogIframe"
				        name="iframe"
				        src="changelog-<? echo $language=idenLang(); ?>.txt"
				        width="981px"
				        height="800px"
				        scrolling="auto"
				        align="top"
